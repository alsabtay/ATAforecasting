...
extern SEXP _ATAforecasting_NaiveS_Accry(SEXP, SEXP, SEXP);
extern SEXP _ATAforecasting_NaiveS_Accry_hin(SEXP, SEXP, SEXP, SEXP);
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_ATAforecasting_NaiveS_Accry",        (DL_FUNC) &_ATAforecasting_NaiveS_Accry,         3},
    {"_ATAforecasting_NaiveS_Accry_hin",    (DL_FUNC) &_ATAforecasting_NaiveS_Accry_hin,     4},
