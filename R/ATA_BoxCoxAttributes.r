...
#' @description This function is set some attributes of Box-Cox power transformation family using \code{ATA.BoxCoxAttr} functions. 
#' The \code{ATA.BoxCoxAttr} function works with many different types of inputs.
#' 
