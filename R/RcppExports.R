...
NaiveS_Accry <- function(train_set, frqx, accry) {
    .Call(`_ATAforecasting_NaiveS_Accry`, train_set, frqx, accry)
}

NaiveS_Accry_hin <- function(train_set, frqx, accry, h) {
    .Call(`_ATAforecasting_NaiveS_Accry_hin`, train_set, frqx, accry, h)
}
